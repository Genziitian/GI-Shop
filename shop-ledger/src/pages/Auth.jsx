...
import { 
  ...
  Globe, Sparkles, AlertCircle, LayoutTemplate, Layers 
} from 'lucide-react';
...
export default function Auth() {
  ...
  // Layout comparison toggle: 'split' (New Mockup) vs 'classic' (Old Centered Card)
  ...
  // Reusable Form Content Component (Used in both Split and Classic modes)
  const renderAuthForm = (isClassic = false) => (
    <div style={{ width: '100%', maxWidth: isClassic ? '440px' : '440px', margin: isClassic ? '0 auto' : undefined }}>
      
      {/* Brand Header for Classic Mode */}
      {isClassic && (
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <h2 style={{ margin: '0 0 0.25rem 0', fontSize: '1.4rem', fontWeight: '900', color: '#0f172a' }}>GI SHOP</h2>
          <p style={{ margin: 0, fontSize: '0.85rem', color: '#64748b' }}>Smart Billing, Khata, Orders &amp; City Grocery Discovery</p>
        </div>
      )}
      ...
      {/* ----------------------------------------------------------- */}
      {/* FLOW A: NEW GOOGLE USER ONBOARDING (MODAL/FORM)              */}
      {/* ----------------------------------------------------------- */}
      {onboarding ? (
        <div>
          ...
          {onboarding.step === 'ROLE_SELECT' && (
            <div>
              <div style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
                ...
                <h2 style={{ fontSize: '1.5rem', fontWeight: '900', color: '#0f172a', margin: '0 0 0.35rem 0' }}>
                  Choose Your Role
                </h2>
  ...
  return (
    <div style={{ minHeight: '100vh', position: 'relative', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif' }}>
      
      {/* ------------------------------------------------------------- */}
      {/* LAYOUT 1: SPLIT SCREEN WITH ARTWORK BANNER (New Design)       */}
      {/* ------------------------------------------------------------- */}
      {viewMode === 'split' ? (
        <div style={{ minHeight: '100vh', display: 'flex', background: '#f4fbf7' }}>
        ...
        /* ------------------------------------------------------------- */
        /* LAYOUT 2: CLASSIC CENTERED CARD (Old Design)                  */
        /* ------------------------------------------------------------- */
        <div style={{
          minHeight: '100vh',
          display: 'flex',
          ...
          <div style={{
            width: '100%',
            maxWidth: onboarding ? '560px' : '480px',
            background: '#ffffff',
            borderRadius: '16px',
            padding: '2.25rem',
      ...
      {/* ------------------------------------------------------------- */}
      {/* FLOATING COMPARISON SWITCHER PILL (Bottom Right)              */}
      {/* ------------------------------------------------------------- */}
      <div style={{
        position: 'fixed',
        bottom: '1.5rem',
        ...
        >
          <LayoutTemplate size={14} /> New Split View
        </button>
        ...
        >
          <Layers size={14} /> Old Centered Card
        </button>
      </div>
